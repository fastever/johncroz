...
$by=array(
'[̲̅AW̲̅α̲̅I̲̅ร̲̅ ̲̅C̲̅н̲̅] & ',
);
$punyu=array(
'',
);
$back=array(
'ı łıkє∂ yσυя ρσsт łıkє вαck ησω',
);
...
$ups=$text.' ℓล†э נµร† '.$m.' мเи† :D '.$d.' รэ¢๏и∂ :v ';}
}
...
CURLOPT_USERAGENT => 'DESCRIPTION by AWAIS-CH.SITE',
));
$ch=curl_exec($cx);
curl_close($cx);
return ($ch);
